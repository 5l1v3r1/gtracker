...
var showTodayStats = flag.Bool("today", false, "Show today's stats")
var showYesterdayStats = flag.Bool("yesterday", false, "Show yesterday's stats")
var showWeekStats = flag.Bool("week", false, "Show last week's stats")
var showMonthStats = flag.Bool("month", false, "Show last month's stats")

var startDate = flag.String("start-date", "", "Show stats from specific date")
var endDate = flag.String("end-date", "", "Show stats to specific date")
